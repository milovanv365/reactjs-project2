					...
					<div className="collapse navbar-collapse" id="mainmenu">
						<ul className="navbar-nav ml-auto" id="mymenu">
							...
							<li className="nav-item dropdown">
								<a href={null} className="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog</a>
						...
						<div className="col-md-6">
							<div className="home-contain">
								<div className="fadeInLeft-land-caption">
									<h2 className="landing-caption text-white">Best App Landing for all your needs.. !</h2>
									<p className="text-white">Chatloop is perfect landing page for game , photoediting , browser or any mobile application landing page  </p>
									<div>
										<a href={`${process.env.PUBLIC_URL}/home`} className="btn btn-inverse mt-2 mr-3">Check Now</a>
									</div>
								</div>
							</div>
						</div>
						<div className="col-md-6 right">
							<div className="home-right">
								<div className="mobile-slid">
									<img src="assets/images/demo/home/weightlifting.png" alt="top1" className="img-fluid" />
								</div>
								<div className="photo">
			        ...
			        <div className="row">
			            <div className="col-md-12">
			                <div className="Copyright-section">
			                    <p>2018- 19 Copyright &copy; powered by Pixelstrap</p>
			                </div>
			            </div>
			        </div>
			    </div>
