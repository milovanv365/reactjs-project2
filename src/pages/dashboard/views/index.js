...
import Team_Roles from './pages/Team_Roles/index'
import BaseProperties from './pages/BaseProperties';
import TableProperties from './pages/TableProperties';
import TableView from './pages/TableView';
import InvitePeople from './pages/InvitePeople/index';
...
const pageList = [
  ...
  },
  {
    ...
    path: '/:basename/:tablename/properties',
  ...
  },
  {
    name: 'Team & Roles',
    path: '/team_roles',
    component: Team_Roles
  },
  {
    name: 'Table View',
    path: '/:basename/:tablename',
    component: TableView
  },
  {
    name: 'Dashboard',
